...
class Fraction {
  ...
  public Fraction(Fraction original) {
    ...
    //numerator = 0;
    //denominator = 1;
    //[[[[[[[[ PART 1: REPLACE THE 2 LINES ABOVE. ]]]]]]]]
  ...
  static private int gcd(int x, int y) {
    ...
    //return 1;
    //[[[[[[[[ PART 4: REPLACE THE LINE ABOVE. ]]]]]]]]
    if (x < 0 || y < 0) {
      System.out.println("Fatal error:  Negative integers when calculating GCD.");
      System.exit(0);
    }
  ...
  public static void main(String[] argv) {
    ...
    System.out.println("The sum of " + f0 + ", " + f1 + " and " + f2 + " is " +
                       sumOfThree);
    */
    //[[[[[[[[ PART 2: REPLACE THE 4 LINES ABOVE. ]]]]]]]]
